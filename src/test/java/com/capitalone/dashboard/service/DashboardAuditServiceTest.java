...
public class DashboardAuditServiceTest {
    ...
    public void runStaticSecurityAuditTests() throws AuditException, IOException {
        DashboardReviewResponse actual = getActualReviewResponse(dashboardAuditService.getDashboardReviewResponse(
                ...
                Sets.newHashSet(AuditType.STATIC_SECURITY_ANALYSIS), AutoDiscoverAuditType.ALL,"" ,"", null), SecurityReviewAuditResponse.class);
    ...
    public void runLibraryPolicyAuditTests() throws AuditException, IOException {
        ...
        DashboardReviewResponse actual = getActualReviewResponse(dashboardAuditService.getDashboardReviewResponse("TestSSA",
                ...
                Sets.newHashSet(AuditType.LIBRARY_POLICY), AutoDiscoverAuditType.ALL,"", "", null), LibraryPolicyAuditResponse.class);
    ...
    public void runPerformanceAuditTests() throws AuditException, IOException {
        DashboardReviewResponse actual = getActualReviewResponse(dashboardAuditService.getDashboardReviewResponse("TestSSA",
                ...
                "confItem",
                1522623841000L, 1526505798000L,
                Sets.newHashSet(AuditType.PERF_TEST), AutoDiscoverAuditType.ALL,"", "", null), PerformanceTestAuditResponse.class);
    ...
    public void runCodeQualityAuditTests() throws AuditException, IOException {
        DashboardReviewResponse actual = getActualReviewResponse(dashboardAuditService.getDashboardReviewResponse("TestSSA",
                ...
                Sets.newHashSet(AuditType.CODE_QUALITY), AutoDiscoverAuditType.ALL,"", "", null), CodeQualityAuditResponse.class);
    ...
    public void runArtifactAuditTests() throws AuditException, IOException {
        DashboardReviewResponse actual = getActualReviewResponse(dashboardAuditService.getDashboardReviewResponse("TestSSA",
                ...
                Sets.newHashSet(AuditType.ARTIFACT), AutoDiscoverAuditType.ALL,"", "", null), ArtifactAuditResponse.class);
    ...
    public void runArtifactAuditTestsWithIdentifierName() throws AuditException, IOException {
        DashboardReviewResponse actual = getActualReviewResponse(dashboardAuditService.getDashboardReviewResponse("TestSSA",
                ...
                "confItem",
                1554140676000L, 1554831876000L,
                Sets.newHashSet(AuditType.ARTIFACT), AutoDiscoverAuditType.ALL,"https://gitrepo/artifactName2/tree/master", "artifactName2", null), ArtifactAuditResponse.class);
        DashboardReviewResponse expected = getExpectedReviewResponse("Artifact.json", ArtifactAuditResponse.class);
    ...
    public void runTestResultsAuditTests() throws AuditException, IOException {
        DashboardReviewResponse actual = getActualReviewResponse(dashboardAuditService.getDashboardReviewResponse("TestSSA",
                ...
                Sets.newHashSet(AuditType.TEST_RESULT), AutoDiscoverAuditType.ALL,"", "", null), TestResultsAuditResponse.class);
