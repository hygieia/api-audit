...
public class DeployEvaluator extends Evaluator<DeployAuditResponse> {
    ...
    public Collection<DeployAuditResponse> evaluate(Dashboard dashboard, long beginDate, long endDate, Map<?, ?> data, String altIdentifier) throws AuditException {
        ...
        List<CollectorItem> deployItems = StringUtils.isNotEmpty(altIdentifier)?getCollectorItems(dashboard, CollectorType.Deployment):getCollectorItemsByAltIdentifier(dashboard, CollectorType.Deployment,altIdentifier);
